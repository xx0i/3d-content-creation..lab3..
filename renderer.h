...
public:
	...
	void initializeViewMatrix()
	{
		...
		interfaceProxy.RotateYGlobalF(translationMatrix, G_PI/-4.0f, translationMatrix);
		interfaceProxy.RotateXGlobalF(translationMatrix, G_PI/-6.0f, translationMatrix);
