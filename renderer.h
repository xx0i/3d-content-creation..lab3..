...
public:
	...
	void initializeViewMatrix()
	{
		...
		shaderVarsUniformBuffer.viewMatrix;
	}
	...
	void initializeWorldMatrices()
	{
		...
		rotationMatrix = GW::MATH::GIdentityMatrixF;
		translationMatrix = GW::MATH::GIdentityMatrixF;
		GW::MATH::GVECTORF wall1Translation = { 0.1f, 0.0f, 0.5f, 1.2f };
		interfaceProxy.RotateZGlobalF(rotationMatrix, G_DEGREE_TO_RADIAN_F(88), rotationMatrix);
