...
public:
	...
	void initializeWorldMatrices()
	{
		...
		interfaceProxy.RotateYLocalF(rotationMatrix, G_DEGREE_TO_RADIAN_F(-15), rotationMatrix);
		interfaceProxy.TranslateLocalF(translationMatrix, wall1Translation, translationMatrix);
