...
public:
	...
	void initializeViewMatrix()
	{
		...
		interfaceProxy.RotateYGlobalF(translationMatrix, G_DEGREE_TO_RADIAN_F(70), translationMatrix);
		interfaceProxy.RotateXGlobalF(translationMatrix, G_DEGREE_TO_RADIAN_F(260), translationMatrix);
