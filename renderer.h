...
public:
	...
	void initializeWorldMatrix1()
	{
		...
		interfaceProxy.RotateYGlobalF(translationMatrix, -G_PI / 16.0f, translationMatrix);
		interfaceProxy.RotateXGlobalF(translationMatrix, -G_PI / 8.0f, translationMatrix);
