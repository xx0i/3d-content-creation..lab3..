...
public:
	...
	void initializeWorldMatrix1()
	{
		...
		interfaceProxy.RotateXGlobalF(translationMatrix, -G_PI / 5.0f, translationMatrix);
		interfaceProxy.RotateYGlobalF(translationMatrix, G_PI / 3.0f, translationMatrix);
