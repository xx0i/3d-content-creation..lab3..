...
public:
	...
	void initializeWorldMatrices()
	{
		...
		interfaceProxy.RotateYGlobalF(rotationMatrix, G_DEGREE_TO_RADIAN_F(75), rotationMatrix);
		interfaceProxy.RotateZGlobalF(rotationMatrix, G_DEGREE_TO_RADIAN_F(25), rotationMatrix);
